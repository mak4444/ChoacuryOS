...
: NCACCEPT00 (  --  ) \ 94
  NCDDDD
\   9 allocate 2drop
  S" "  OPEN-DIR 2drop \ THROW TO DIR_ID

;

: WWWTST  0 ?DO NEXT-LINE LOOP ; 
 ...
 LASTSTP: NCACCEPT00
 LASTSTP: PAGE_DOWN_DO
 LASTSTP: VIEW-#Y0>  44 WWWTST TYPE
 LASTSTP: VIEW-#Y0> NEXT-LINE TYPE
 LASTSTP: VIEW-#Y0>  TYPE
 LASTSTP: EDIT ttt.txt
 LASTSTP: S" qwerty asdfgh" bl scan type
...
.( cli> <command text> - вызов системный команды) cr
